...
* coefficients are a bit harder to interpret, but could center for a more direct interpretation
* can still compute fitted probabilities, classifications, etc. the same as for the logit model