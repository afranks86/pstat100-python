...
One straightforward view is that a **statistical model** is simply a _**probabilistic a data-generating process**_. In other words, a probability distribution.
...
A prediction grid can be used to visualize the line.
